-- Create cron job to send text verification reminders every minute
SELECT cron.schedule(
  'send-text-verification-reminders',
  '* * * * *', -- Every minute
  $$
  SELECT
    net.http_post(
        url:='https://ezvwyfqtyanwnoyymhav.supabase.co/functions/v1/send-text-verification-reminders',
