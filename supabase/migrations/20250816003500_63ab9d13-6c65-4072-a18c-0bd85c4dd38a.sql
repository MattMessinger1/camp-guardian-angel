-- Phase A.1: Sessions Schema for Public Ingestion and Search
...
CREATE INDEX IF NOT EXISTS idx_sessions_location_geo ON public.sessions USING GIST(ll_to_earth(lat, lng)) WHERE lat IS NOT NULL AND lng IS NOT NULL;
