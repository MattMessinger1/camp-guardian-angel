-- Add new platform types to the provider_platform enum
...
ALTER TYPE provider_platform ADD VALUE IF NOT EXISTS 'ymca';
ALTER TYPE provider_platform ADD VALUE IF NOT EXISTS 'communitypass';
ALTER TYPE provider_platform ADD VALUE IF NOT EXISTS 'activecommunities';

-- Now seed provider_profiles table with common providers
-- Clear existing data first
DELETE FROM provider_profiles;

-- Insert core provider profiles using correct enum values
