export type ProviderPlatform = 'jackrabbit_class' | 'daysmart_recreation' | 'shopify_product' | 'playmetrics' | 'resy' | 'opentable' | 'peloton' | 'ticketmaster' | 'eventbrite' | 'skiclubpro';
